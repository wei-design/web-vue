...
const Button = defineComponent({
  ...
  setup(props, {
    ...
    const classString = className(["wei-button", `wei-button-type-${props.type}`, `wei-button-size-${props.size}`, props.disabled ? "wei-button-disabled" : ""]);
...
export { Button as WeiButton, index as default };
